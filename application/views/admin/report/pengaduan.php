...
<section class="content">
	<div class="box">
        ...
        <div class="box-header" style="margin-bottom: -17px;">
          <h3 class="box-title" style="float: left; font-family: semua;">Data Pengaduan</h3><br>
          <form class="pull-right" action="<?=site_url('sistem/report/pengaduan')?>" method="post" style="margin-top: -17px;">
	        ...
	        <?php if ($detail == ''){ ?>	
          	<a class="btn btn-sm btn-success print" href="<?=site_url('sistem/report/printPengaduan')?>" style="float: right; margin: 0 0 0 7px;"><i class="fa fa-print"></i> Cetak</a>
	        <?php } else{ ?>
          	<a class="btn btn-sm btn-success print" href="<?=site_url('sistem/report/printPengaduan/'.$awal.'/'.$akhir)?>" style="float: right; margin: 0 0 0 7px;"><i class="fa fa-print"></i> Cetak</a>
	        <?php } ?>
